...
func (client *BackendAppTag) Get(appId string) (BackendApp, error) {
	...
	u, err := url.Parse(client.internal.Parser.Url("/backend/app/$app_id<[0-9]+>", pathParams))
	if err != nil {
		return BackendApp{}, errors.New("could not parse url")
	}
	...
	if err != nil {
		return BackendApp{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return BackendApp{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return BackendApp{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return BackendApp{}, errors.New("could not unmarshal JSON response")
		}
...
func (client *BackendAppTag) GetAll(startIndex int, count int, search string) (BackendAppCollection, error) {
	...
	u, err := url.Parse(client.internal.Parser.Url("/backend/app", pathParams))
	if err != nil {
		return BackendAppCollection{}, errors.New("could not parse url")
	}
	...
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return BackendAppCollection{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return BackendAppCollection{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return BackendAppCollection{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return BackendAppCollection{}, errors.New("could not unmarshal JSON response")
		}
...
func (client *BackendAppTag) GetToken(tokenId string) (BackendAppToken, error) {
	...
	if err != nil {
		return BackendAppToken{}, errors.New("could not parse url")
	}
	...
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return BackendAppToken{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return BackendAppToken{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return BackendAppToken{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return BackendAppToken{}, errors.New("could not unmarshal JSON response")
		}
...
// GetAllTokens
func (client *BackendAppTag) GetAllTokens(startIndex int, count int, search string, from time.Time, to time.Time, appId int, userId int, status int, scope string, ip string) (BackendAppTokenCollection, error) {
	pathParams := make(map[string]interface{})
	...
	if err != nil {
		return BackendAppTokenCollection{}, errors.New("could not parse url")
	}
	...
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return BackendAppTokenCollection{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return BackendAppTokenCollection{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return BackendAppTokenCollection{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return BackendAppTokenCollection{}, errors.New("could not unmarshal JSON response")
		}
