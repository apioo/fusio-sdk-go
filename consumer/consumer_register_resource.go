...
type ConsumerRegisterResource struct {
	url    string
	client *http.Client
}

// ConsumerActionUserRegister
func (resource ConsumerRegisterResource) ConsumerActionUserRegister(data UserRegister) (Message, error) {
...
func NewConsumerRegisterResource(resource *sdkgen.Resource) *ConsumerRegisterResource {
	return &ConsumerRegisterResource{
		url:    resource.BaseUrl + "/consumer/register",
