...
func (client *ConsumerAccountTag) Refresh(payload ConsumerUserRefresh) (ConsumerUserJWT, error) {
	...
	if err != nil {
		return ConsumerUserJWT{}, errors.New("could not parse url")
	}
	...
	raw, err := json.Marshal(payload)
	if err != nil {
		return ConsumerUserJWT{}, errors.New("could not marshal provided JSON data")
	}
	...
	req, err := http.NewRequest("PUT", u.String(), reqBody)
	if err != nil {
		return ConsumerUserJWT{}, errors.New("could not create request")
	}
	...
	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return ConsumerUserJWT{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return ConsumerUserJWT{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return ConsumerUserJWT{}, errors.New("could not unmarshal JSON response")
		}
...
func (client *ConsumerAccountTag) Authorize(payload ConsumerAuthorizeRequest) (ConsumerAuthorizeResponse, error) {
	...
	if err != nil {
		return ConsumerAuthorizeResponse{}, errors.New("could not parse url")
	}
	...
	raw, err := json.Marshal(payload)
	if err != nil {
		return ConsumerAuthorizeResponse{}, errors.New("could not marshal provided JSON data")
	}
	...
	req, err := http.NewRequest("POST", u.String(), reqBody)
	if err != nil {
		return ConsumerAuthorizeResponse{}, errors.New("could not create request")
	}
	...
	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return ConsumerAuthorizeResponse{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return ConsumerAuthorizeResponse{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return ConsumerAuthorizeResponse{}, errors.New("could not unmarshal JSON response")
		}
...
func (client *ConsumerAccountTag) GetApp() (ConsumerAuthorizeMeta, error) {
	...
	u, err := url.Parse(client.internal.Parser.Url("/consumer/authorize", pathParams))
	if err != nil {
		return ConsumerAuthorizeMeta{}, errors.New("could not parse url")
	}
	...
	if err != nil {
		return ConsumerAuthorizeMeta{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return ConsumerAuthorizeMeta{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return ConsumerAuthorizeMeta{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return ConsumerAuthorizeMeta{}, errors.New("could not unmarshal JSON response")
		}
...
func (client *ConsumerAccountTag) Get() (ConsumerUserAccount, error) {
	...
	u, err := url.Parse(client.internal.Parser.Url("/consumer/account", pathParams))
	if err != nil {
		return ConsumerUserAccount{}, errors.New("could not parse url")
	}
	...
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return ConsumerUserAccount{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return ConsumerUserAccount{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return ConsumerUserAccount{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return ConsumerUserAccount{}, errors.New("could not unmarshal JSON response")
		}
