...
type BackendAppTokenResource struct {
	url    string
	client *http.Client
}

// BackendActionAppTokenGetAll
func (resource BackendAppTokenResource) BackendActionAppTokenGetAll(query BackendAppTokenCollectionQuery) (AppTokenCollection, error) {
	...
	if err != nil {
		return AppTokenCollection{}, errors.New("could not marshall query")
	}
...
func NewBackendAppTokenResource(resource *sdkgen.Resource) *BackendAppTokenResource {
	return &BackendAppTokenResource{
		url:    resource.BaseUrl + "/backend/app/token",
