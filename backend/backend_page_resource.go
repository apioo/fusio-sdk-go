...
type BackendPageResource struct {
	url    string
	client *http.Client
}

// BackendActionPageGetAll
func (resource BackendPageResource) BackendActionPageGetAll(query CollectionQuery) (PageCollection, error) {
...
// BackendActionPageCreate
func (resource BackendPageResource) BackendActionPageCreate(data PageCreate) (Message, error) {
	url, err := url.Parse(resource.url)
	if err != nil {
...
func NewBackendPageResource(resource *sdkgen.Resource) *BackendPageResource {
	return &BackendPageResource{
		url:    resource.BaseUrl + "/backend/page",
