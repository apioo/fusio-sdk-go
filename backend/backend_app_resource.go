...
type BackendAppResource struct {
	url    string
	client *http.Client
}

// BackendActionAppGetAll
func (resource BackendAppResource) BackendActionAppGetAll(query CollectionQuery) (AppCollection, error) {
...
// BackendActionAppCreate
func (resource BackendAppResource) BackendActionAppCreate(data AppCreate) (Message, error) {
	url, err := url.Parse(resource.url)
	if err != nil {
...
func NewBackendAppResource(resource *sdkgen.Resource) *BackendAppResource {
	return &BackendAppResource{
		url:    resource.BaseUrl + "/backend/app",
