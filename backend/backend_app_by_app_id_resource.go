...
type BackendAppByAppIdResource struct {
	url    string
	client *http.Client
}

// BackendActionAppGet
func (resource BackendAppByAppIdResource) BackendActionAppGet() (App, error) {
...
// BackendActionAppUpdate
func (resource BackendAppByAppIdResource) BackendActionAppUpdate(data AppUpdate) (Message, error) {
	url, err := url.Parse(resource.url)
	if err != nil {
...
// BackendActionAppDelete
func (resource BackendAppByAppIdResource) BackendActionAppDelete() (Message, error) {
	url, err := url.Parse(resource.url)
	if err != nil {
		return Message{}, errors.New("could not parse url")
	}
...
func NewBackendAppByAppIdResource(appId string, resource *sdkgen.Resource) *BackendAppByAppIdResource {
	return &BackendAppByAppIdResource{
		url:    resource.BaseUrl + "/backend/app/" + appId + "",
