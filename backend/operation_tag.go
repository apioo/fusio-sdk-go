...
// Delete
func (client *OperationTag) Delete(operationId string) (Message, error) {
...
// Update
func (client *OperationTag) Update(operationId string, payload OperationUpdate) (Message, error) {
	pathParams := make(map[string]interface{})
	pathParams["operation_id"] = operationId
...
// Get
func (client *OperationTag) Get(operationId string) (Operation, error) {
	pathParams := make(map[string]interface{})
	pathParams["operation_id"] = operationId
	...
	if err != nil {
		return Operation{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return Operation{}, errors.New("could not send request")
	}
...
// Create
func (client *OperationTag) Create(payload OperationCreate) (Message, error) {
	pathParams := make(map[string]interface{})
...
func (client *OperationTag) GetAll(startIndex int, count int, search string) (OperationCollection, error) {
	...
	u, err := url.Parse(client.internal.Parser.Url("/backend/operation", pathParams))
	if err != nil {
		return OperationCollection{}, errors.New("could not parse url")
	}
	...
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return OperationCollection{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return OperationCollection{}, errors.New("could not send request")
	}
...
func NewOperationTag(httpClient *http.Client, parser *sdkgen.Parser) *OperationTag {
	return &OperationTag{
		internal: &sdkgen.TagAbstract{
