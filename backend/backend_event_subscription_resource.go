...
type BackendEventSubscriptionResource struct {
	url    string
	client *http.Client
}

// BackendActionEventSubscriptionGetAll
func (resource BackendEventSubscriptionResource) BackendActionEventSubscriptionGetAll(query CollectionQuery) (EventSubscriptionCollection, error) {
...
// BackendActionEventSubscriptionCreate
func (resource BackendEventSubscriptionResource) BackendActionEventSubscriptionCreate(data EventSubscriptionCreate) (Message, error) {
	url, err := url.Parse(resource.url)
	if err != nil {
...
func NewBackendEventSubscriptionResource(resource *sdkgen.Resource) *BackendEventSubscriptionResource {
	return &BackendEventSubscriptionResource{
		url:    resource.BaseUrl + "/backend/event/subscription",
