...
type BackendSchemaResource struct {
	url    string
	client *http.Client
}

// BackendActionSchemaGetAll
func (resource BackendSchemaResource) BackendActionSchemaGetAll(query CollectionCategoryQuery) (SchemaCollection, error) {
	...
	if err != nil {
		return SchemaCollection{}, errors.New("could not marshall query")
	}
...
// BackendActionSchemaCreate
func (resource BackendSchemaResource) BackendActionSchemaCreate(data SchemaCreate) (Message, error) {
	url, err := url.Parse(resource.url)
	if err != nil {
...
func NewBackendSchemaResource(resource *sdkgen.Resource) *BackendSchemaResource {
	return &BackendSchemaResource{
		url:    resource.BaseUrl + "/backend/schema",
