...
func (client *BackendRateTag) Get(rateId string) (BackendRate, error) {
	...
	u, err := url.Parse(client.internal.Parser.Url("/backend/rate/$rate_id<[0-9]+|^~>", pathParams))
	if err != nil {
		return BackendRate{}, errors.New("could not parse url")
	}
	...
	if err != nil {
		return BackendRate{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return BackendRate{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return BackendRate{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return BackendRate{}, errors.New("could not unmarshal JSON response")
		}
...
func (client *BackendRateTag) GetAll(startIndex int, count int, search string) (BackendRateCollection, error) {
	...
	u, err := url.Parse(client.internal.Parser.Url("/backend/rate", pathParams))
	if err != nil {
		return BackendRateCollection{}, errors.New("could not parse url")
	}
	...
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return BackendRateCollection{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return BackendRateCollection{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return BackendRateCollection{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return BackendRateCollection{}, errors.New("could not unmarshal JSON response")
		}
