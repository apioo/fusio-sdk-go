...
func (client *BackendActionTag) Get(actionId string) (BackendAction, error) {
	...
	u, err := url.Parse(client.internal.Parser.Url("/backend/action/$action_id<[0-9]+|^~>", pathParams))
	if err != nil {
		return BackendAction{}, errors.New("could not parse url")
	}
	...
	if err != nil {
		return BackendAction{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return BackendAction{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return BackendAction{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return BackendAction{}, errors.New("could not unmarshal JSON response")
		}
...
func (client *BackendActionTag) Execute(actionId string, payload BackendActionExecuteRequest) (BackendActionExecuteResponse, error) {
	...
	if err != nil {
		return BackendActionExecuteResponse{}, errors.New("could not parse url")
	}
	...
	raw, err := json.Marshal(payload)
	if err != nil {
		return BackendActionExecuteResponse{}, errors.New("could not marshal provided JSON data")
	}
	...
	if err != nil {
		return BackendActionExecuteResponse{}, errors.New("could not create request")
	}
	...
	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return BackendActionExecuteResponse{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return BackendActionExecuteResponse{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return BackendActionExecuteResponse{}, errors.New("could not unmarshal JSON response")
		}
...
func (client *BackendActionTag) GetClasses() (BackendActionIndex, error) {
	...
	if err != nil {
		return BackendActionIndex{}, errors.New("could not parse url")
	}
	...
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return BackendActionIndex{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return BackendActionIndex{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return BackendActionIndex{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return BackendActionIndex{}, errors.New("could not unmarshal JSON response")
		}
...
func (client *BackendActionTag) GetAll(startIndex int, count int, search string) (BackendActionCollection, error) {
	...
	u, err := url.Parse(client.internal.Parser.Url("/backend/action", pathParams))
	if err != nil {
		return BackendActionCollection{}, errors.New("could not parse url")
	}
	...
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return BackendActionCollection{}, errors.New("could not create request")
	}

	resp, err := client.internal.HttpClient.Do(req)
	if err != nil {
		return BackendActionCollection{}, errors.New("could not send request")
	}
	...
	respBody, err := io.ReadAll(resp.Body)
	if err != nil {
		return BackendActionCollection{}, errors.New("could not read response body")
	}
	...
	if resp.StatusCode >= 200 && resp.StatusCode < 300 {
		...
		err = json.Unmarshal(respBody, &response)
		if err != nil {
			return BackendActionCollection{}, errors.New("could not unmarshal JSON response")
		}
